...
author = u'Bertrand Néron, Eloi Littner, Matthieu Haudiquet, Amandine Perrin, Jean Cury, Eduardo P.C. Rocha'
...
htmlhelp_basename = 'IntegronFinderdoc'
...
man_pages = [
    (master_doc, 'integronfinder', u'IntegronFinder Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'IntegronFinder', u'IntegronFinder Documentation',
   author, 'IntegronFinder', 'One line description of project.',
   'Miscellaneous'),
]
