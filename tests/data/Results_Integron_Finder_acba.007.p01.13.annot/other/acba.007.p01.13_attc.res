...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# query CM file:                         /home/bneron/Projects/Integron_Finder/data/Models/attc_4.cm
# target sequence database:              /home/bneron/Projects/Integron_Finder/tests/data/acba.007.p01.13.fst
# output directed to file:               /tmp/integron_lian_test/Results_Integron_Finder_acba.007.p01.13/other/acba.007.p01.13_attc.res
# tabular output of hits:                /tmp/integron_lian_test/Results_Integron_Finder_acba.007.p01.13/other/acba.007.p01.13_attc_table.res
...
Windows   passing  local HMM SSV           filter:              18  (0.3707); expected (0.35)
Windows   passing  local HMM Viterbi       filter:                  (off)
Windows   passing  local HMM Viterbi  bias filter:                  (off)
Windows   passing  local HMM Forward       filter:               4  (0.0899); expected (0.02)
Windows   passing  local HMM Forward  bias filter:               4  (0.0899); expected (0.02)
Windows   passing glocal HMM Forward       filter:               3  (0.07474); expected (0.02)
Windows   passing glocal HMM Forward  bias filter:               3  (0.07474); expected (0.02)
Envelopes passing glocal HMM envelope defn filter:               5  (0.01089); expected (0.02)
